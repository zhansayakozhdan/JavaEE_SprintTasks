...
<form action="/editPost" method="post">
    ...
    <div class="mb-3">
        ...
        <input value="<%=post.getContent()%>" name="post_content" type="text" class="form-control" id="exampleInputDescription">
    </div>
    <div class="mb-3">
        ...
        <select class=" form-control custom-select my-1 mr-sm-2" name="category_id">
            ...
            %>
            <option value="<%=c.getId()%>" id="category" <% if(c.getId() == post.getCategory().getId()){ System.out.print("selected");}%> >
                <%=c.getCategoryName()%>
            </option>
            <%
                    }
